...
describe Dessert do
  let(:chef) { double("chef", name: "Awesome") }
  ...
  describe "#initialize" do
    ...
    it "raises an argument error when given a non-integer quantity" do
      expect{Dessert.new("cookie", "hi", chef)}.to raise_error(ArgumentError)
    end
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = ['eggs', 'flour', 'baking soda']
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      allow(chef).to receive(:titleize).and_return("Chef Awesome the Great Baker")
    end
  end
